MACRO( COPYSRC COPY_IN_PATH COPY_IN_FILE COPY_OUT_PATH COPY_OUT_FILE )
  ...
  CONFIGURE_FILE( ${CMAKE_CURRENT_SOURCE_DIR}/CMake/modules/copySrc.cmake.in ${CMAKE_CURRENT_BINARY_DIR}${CMAKE_FILES_DIRECTORY}/${OUT_FILE}.cmake @ONLY)
  # add custom target
  ADD_CUSTOM_COMMAND( OUTPUT ${OUT_PATH}/${OUT_FILE}
    ...
    DEPENDS ${CMAKE_CURRENT_SOURCE_DIR}/CMake/modules/copySrc.cmake.in ${IN_PATH}/${IN_FILE}
