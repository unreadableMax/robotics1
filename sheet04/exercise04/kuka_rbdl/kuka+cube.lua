...
model = {
  ...
  frames = {
  {
	...
	-- Maybe the IK fails at this point, because some angles are "intrinsically redundant" for this task (Cube's trajectory only varies at two translations and one rotation), which causes multiple solutions to be possible.
}
